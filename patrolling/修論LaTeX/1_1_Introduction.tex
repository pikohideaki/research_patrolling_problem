...
$V$の各頂点には\defword{利得}および\defword{{\maxIdletime}}と呼ばれる正整数が定まっている．
...
巡査は$A$により$W$を\defword{警邏}するという．
...
また，利得最大化ではなく全点を定時訪問できるか否かを判定する問題を{\timeSpecifiedPatProbDecision}と呼ぶ．
